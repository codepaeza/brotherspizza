...
public class ListaPizzaAdapter extends BaseAdapter {

    private Context context;
    private List<ListaPizza> items;

    public ListaPizzaAdapter(Context context, List<ListaPizza> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView = inflater.inflate(R.layout.lista_pizza, parent, false);
        }
        ...
        ListaPizza item = this.items.get(position);
